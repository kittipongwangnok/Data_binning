...
InputFile = open("dpleo_20200131_run009kg5.inp",'r').readlines()
...
#Please change the input file
for line in open("dpleo_20200131_run009kg5.inp"):
    li=line.strip()
...
f = open("range_dpleo_20200131_run009kg5.out", 'w')
...
InputFile_1 = "range_dpleo_20200131_run009kg5.out"
...
plt.legend()
plt.savefig("Unbinned_Data_binning_dpleo_20200131_run009kg5.png")
plt.show()
...
plt.ylabel('Relative flux')
plt.legend()
plt.savefig("Binned_Data_binning_dpleo_20200131_run009kg5.png")
plt.show()
