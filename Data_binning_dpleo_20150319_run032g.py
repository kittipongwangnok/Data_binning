...
InputFile = open("dpleo_20150319_run032g.inp",'r').readlines()
...
#Please change the input file
for line in open("dpleo_20150319_run032g.inp"):
    li=line.strip()
...
plt.legend()
plt.savefig("Unbinned_Data_binning_dpleo_20150319_run032g.png")
plt.show()
...
plt.ylabel('Relative flux')
plt.legend()
plt.savefig("Binned_Data_binning_dpleo_20150319_run032g.png")
plt.show()
