...
plt.legend()
plt.savefig("Unbinned_Data_binning_dpleo_20200122_run028g.png")
plt.show()
...
plt.ylabel('Relative flux')
plt.legend()
plt.savefig("Binned_Data_binning_dpleo_20200122_run028g.png")
plt.show()
...
f = open("Binned_Data_binning_dpleo_20200122_run028g.dat", 'w')
for i in range(len(data_lroche)):
    f.write(str(data_lroche[i])+ '\n')
f.close()
