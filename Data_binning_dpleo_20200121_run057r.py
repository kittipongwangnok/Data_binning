...
InputFile = open("dpleo_20200121_run057r.inp",'r').readlines()
...
#Please change the input file
for line in open("dpleo_20200121_run057r.inp"):
    li=line.strip()
...
plt.legend()
plt.savefig("Unbinned_Data_binning_dpleo_20200121_run057r.png")
plt.show()
...
plt.ylabel('Relative flux')
plt.legend()
plt.savefig("Binned_Data_binning_dpleo_20200121_run057r.png")
plt.show()
