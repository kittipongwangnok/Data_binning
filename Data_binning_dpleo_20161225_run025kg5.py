...
InputFile = open("dpleo_20161225_run025kg5.inp",'r').readlines()
...
#Please change the input file
for line in open("dpleo_20161225_run025kg5.inp"):
    li=line.strip()
...
f = open("range_dpleo_20161225_run025kg5.out", 'w')
...
InputFile_1 = "range_dpleo_20161225_run025kg5.out"
...
plt.legend()
plt.savefig("Unbinned_Data_binning_dpleo_20161225_run025kg5.png")
plt.show()
...
plt.ylabel('Relative flux')
plt.legend()
plt.savefig("Binned_Data_binning_dpleo_20161225_run025kg5.png")
plt.show()
...
f = open("Binned_Data_binning_dpleo_20161225_run025kg5.dat", 'w')
for i in range(len(data_lroche)):
    f.write(str(data_lroche[i])+ '\n')
f.close()
