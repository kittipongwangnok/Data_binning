...
InputFile = open("dpleo_20200317_run031g.inp",'r').readlines()
...
#Please change the input file
for line in open("dpleo_20200317_run031g.inp"):
    li=line.strip()
...
plt.legend()
plt.savefig("Unbinned_Data_binning_dpleo_20200317_run031g.png")
plt.show()
...
plt.ylabel('Relative flux')
plt.legend()
plt.savefig("Binned_Data_binning_dpleo_20200317_run031g.png")
plt.show()
