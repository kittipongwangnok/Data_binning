...
InputFile = open("dpleo_20190227_run039kg5_block.inp",'r').readlines()
...
#Please change the input file
for line in open("dpleo_20190227_run039kg5_block.inp"):
    li=line.strip()
...
f = open("range_dpleo_20190227_run039kg5.out", 'w')
...
InputFile_1 = "range_dpleo_20190227_run039kg5.out"
...
plt.legend()
plt.savefig("Unbinned_Data_binning_dpleo_20190227_run039kg5.png")
plt.show()
...
plt.ylabel('Relative flux')
plt.legend()
plt.savefig("Binned_Data_binning_dpleo_20190227_run039kg5.png")
plt.show()
