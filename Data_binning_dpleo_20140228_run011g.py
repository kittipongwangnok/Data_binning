...
InputFile = open("dpleo_20140228_run011g.inp",'r').readlines()
...
#Please change the input file
for line in open("dpleo_20140228_run011g.inp"):
    li=line.strip()
...
plt.legend()
plt.savefig("Unbinned_Data_binning_dpleo_20140228_run011g.png")
plt.show()
...
plt.ylabel('Relative flux')
plt.legend()
plt.savefig("Binned_Data_binning_dpleo_20140228_run011g.png")
plt.show()
